...
namespace CluedIn.Crawling.Skype.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<ISkypeClientFactory>().AsFactory())
                .Register(Component.For<SkypeClient>().LifestyleTransient());
