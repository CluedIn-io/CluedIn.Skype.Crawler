...
{
    public class DataIngestion : IClassFixture<SkypeTestFixture>
    {
        private readonly SkypeTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(SkypeTestFixture fixture, ITestOutputHelper output)
        {
